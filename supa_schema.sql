...
CREATE TABLE IF NOT EXISTS settings (
  ...
  default_selection_enabled BOOLEAN DEFAULT true,
  default_download_enabled BOOLEAN DEFAULT true,
  default_extra_enabled BOOLEAN DEFAULT false,
  default_extra_max_photos INTEGER,
  default_extra_expiry_days INTEGER,
  default_print_selection_enabled BOOLEAN DEFAULT false,
